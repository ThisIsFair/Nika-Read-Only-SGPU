# Is the guide still working fine? Please lmk via issues tab, and I will try resolving the issues. The new steps are added in the [EXPERIMENTAL GUIDE](https://github.com/ThisIsFair/Nika-Read-Only-SGPU/blob/main/EXPERIMENTAL%20GUIDE.md)
